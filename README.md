# Original author of the project http://clemensbartz.de/

> Since it is difficult to find the source code, the source code of this warehouse is from [de.clemensbartz.android.launcher](https://apt.izzysoft.de/fdroid/index/apk/de.clemensbartz.android.launcher?repo=archive) 2.2 version apk file, decompiled in jadx, exported as Gradle project
>
> update Gradle 7.5，The latest version of Android Studio can be opened, but please set the jdk version of Gradle to 17
>
> Simple fix of compilation issues


# The following may be from the original project README.md
