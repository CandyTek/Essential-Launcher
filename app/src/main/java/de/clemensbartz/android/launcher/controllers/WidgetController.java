...
public final class WidgetController {
	...
	public void addHostView(int i) {
		...
		if (appWidgetInfo != null) {
			...
			createView.updateAppWidgetOptions(
					BundleUtil.getWidgetOptionsBundle(frameLayout.getMeasuredWidth(),frameLayout.getMeasuredHeight(),
							frameLayout.getMeasuredWidth(),frameLayout.getMeasuredHeight()));
	...
	public void adjustWidget(int i) {
		...
		if (frameLayout.getChildCount() == 1) {
			...
			if (childAt instanceof AppWidgetHostView) {
				((AppWidgetHostView) childAt).updateAppWidgetOptions(
						BundleUtil.getWidgetOptionsBundle(frameLayout.getMeasuredWidth(),frameLayout.getMeasuredHeight(),
								frameLayout.getMeasuredWidth(),frameLayout.getMeasuredHeight()));
			}
		}
	...
	public void requestWidgetLayoutChange() {
		...
		popupMenu.setOnMenuItemClickListener(
				new PopupMenu.OnMenuItemClickListener() { // from class: de.clemensbartz.android.launcher.controllers.WidgetController.1
